...
public struct RingBuffer<Element> {
    ...
    internal private(set) var headIndex: Int = 0

    /// The index where appended values will be written to
    internal private(set) var tailIndex: Int = 0
    ...
    public mutating func enqueue<C>(contentsOf collection: C) where C: Collection, C.Element == Element {
